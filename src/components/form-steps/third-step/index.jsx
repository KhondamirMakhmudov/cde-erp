...
const ThirdStep = ({ clickToTheFourthStep, clickToTheSecondStep }) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <h5 className="text-black px-[16px] py-[12px]">
          O‘rnatilgan tartibda tegishli idora va tashkilotlar bilan tasdiqlangan
          loyihalash topshirig‘i (qachon va kim tomonidan)
        </h5>
      ...
      <div>
        <h5 className="text-black px-[16px] py-[12px]">
          ...
          tarmoqlarini nazorat qiluvchi va foydalanuvchi manfaatdor tashkilotlar
          bilan kelishilgan materiallar
        </h5>
