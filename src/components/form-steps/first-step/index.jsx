...
const FirstStep = ({
  initialOption,
  initialSection,
  clickToTheSecondStep,
  defaultOption = ["Option 1", "Option 2", "Option 3"],
}) => {
  ...
  return (
    <div className=" w-4/5 grid grid-cols-12 gap-x-[16px] bg-white py-[12px] px-[16px] rounded-xl border border-[#F5F5F5] mt-[12px]">
      ...
      >
        <Image src={"/icons/bank.svg"} alt="bank" width={40} height={40} />
      ...
      <div className="col-span-12 relative mt-[12px]">
        ...
        >
          ...
          <Image src={"/images/down.png"} alt="down" width={20} height={20} />
        </div>
        {isOpen && (
